...
export default function SettingsPage() {
  ...
  const msgStyle = (msg: string) =>
    msg.startsWith('✅') ? 'mt-3 p-3 rounded-lg text-sm bg-green-50 text-green-700' : 'mt-3 p-3 rounded-lg text-sm bg-red-50 text-red-600'
          ...
          {hospitalLink?.linked ? (
            ...
            <div className="p-6">
              <p className="text-sm text-gray-500 mb-3">
                병원에서 받은 코드를 입력하면 12주 무료 재활 프로그램에 참여할 수 있습니다.
              </p>
              <button
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="divide-y">
            ...
            {isKakaoUser ? (
              ...
              <button
                onClick={() => { setCurrentPw(''); setNewPw(''); setConfirmPw(''); setPwMessage(''); setShowPasswordModal(true) }}
                className="w-full px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition"
              >
                <div className="flex items-center gap-3">
                  <span className="text-xl">🔒</span>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="divide-y">
            ...
            >
              ...
              <div
                className={notifEnabled ? 'w-12 h-7 rounded-full relative bg-blue-500' : 'w-12 h-7 rounded-full relative bg-gray-300'}
              >
                <div
          ...
          <div className="divide-y">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-blue-500 font-medium">{subscriptionLabel}</span>
                <span className="text-gray-400">→</span>
              </div>
            </button>
            <div className="w-full px-6 py-4 flex items-center justify-between opacity-50">
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-5">
          <div className="bg-white rounded-2xl p-7 w-full max-w-sm">
            ...
            <form onSubmit={handleLinkHospital}>
              ...
              />
              {hospitalMessage && (
                <div className={msgStyle(hospitalMessage)}>{hospitalMessage}</div>
              )}
              <button
                type="submit"
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-5">
          <div className="bg-white rounded-2xl p-7 w-full max-w-sm">
            ...
            {pwMessage && (
              <div className={msgStyle(pwMessage)}>{pwMessage}</div>
            )}
            <button
